...
////////////////////////////////////////////////////////////////////////////////
// Input FIFOs
extern fifo_i16_t *HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Src;
...
#define tokens_Src HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Src->contents

extern connection_t connection_HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Src;
#define rate_Src connection_HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Src.rate
...
////////////////////////////////////////////////////////////////////////////////
// Output FIFOs
extern fifo_i16_t *HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Dst;
...
#define tokens_Dst HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Dst->contents
...
static void read_Src() {
	index_Src = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Src->read_inds[0];
	numTokens_Src = index_Src + fifo_i16_get_num_tokens(HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Src, 0);
}

static void read_end_Src() {
	HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Src->read_inds[0] = index_Src;
}

static void write_Dst() {
	index_Dst = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Dst->write_ind;
	numFree_Dst = index_Dst + fifo_i16_get_room(HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Dst, NUM_READERS_Dst, SIZE_Dst);
}

static void write_end_Dst() {
	HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Dst->write_ind = index_Dst;
}
...
static void untagged_0_aligned() {
	...
	tmp_g_aiT32 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[0][0];
	tmp_Src0 = tokens_Src[(index_Src % SIZE_Src) + (16)];
	tmp_g_aiT320 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[16][0];
	evenEvenEvenEven[0] = tmp_Src * tmp_g_aiT32 + tmp_Src0 * tmp_g_aiT320;
	tmp_Src1 = tokens_Src[(index_Src % SIZE_Src) + (0)];
	tmp_g_aiT321 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[0][1];
	tmp_Src2 = tokens_Src[(index_Src % SIZE_Src) + (16)];
	tmp_g_aiT322 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[16][1];
	evenEvenEvenEven[1] = tmp_Src1 * tmp_g_aiT321 + tmp_Src2 * tmp_g_aiT322;
	tmp_Src3 = tokens_Src[(index_Src % SIZE_Src) + (8)];
	tmp_g_aiT323 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[8][0];
	tmp_Src4 = tokens_Src[(index_Src % SIZE_Src) + (24)];
	tmp_g_aiT324 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[24][0];
	evenEvenEvenOdd[0] = tmp_Src3 * tmp_g_aiT323 + tmp_Src4 * tmp_g_aiT324;
	tmp_Src5 = tokens_Src[(index_Src % SIZE_Src) + (8)];
	tmp_g_aiT325 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[8][1];
	tmp_Src6 = tokens_Src[(index_Src % SIZE_Src) + (24)];
	tmp_g_aiT326 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[24][1];
	...
	while (i <= 3) {
		...
		tmp_g_aiT327 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[4][i];
		tmp_Src8 = tokens_Src[(index_Src % SIZE_Src) + (12)];
		tmp_g_aiT328 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[12][i];
		tmp_Src9 = tokens_Src[(index_Src % SIZE_Src) + (20)];
		tmp_g_aiT329 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[20][i];
		tmp_Src10 = tokens_Src[(index_Src % SIZE_Src) + (28)];
		tmp_g_aiT3210 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[28][i];
	...
	while (i0 <= 7) {
		...
		tmp_g_aiT3211 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[2][i0];
		tmp_Src12 = tokens_Src[(index_Src % SIZE_Src) + (6)];
		tmp_g_aiT3212 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[6][i0];
		tmp_Src13 = tokens_Src[(index_Src % SIZE_Src) + (10)];
		tmp_g_aiT3213 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[10][i0];
		tmp_Src14 = tokens_Src[(index_Src % SIZE_Src) + (14)];
		tmp_g_aiT3214 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[14][i0];
		tmp_Src15 = tokens_Src[(index_Src % SIZE_Src) + (18)];
		tmp_g_aiT3215 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[18][i0];
		tmp_Src16 = tokens_Src[(index_Src % SIZE_Src) + (22)];
		tmp_g_aiT3216 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[22][i0];
		tmp_Src17 = tokens_Src[(index_Src % SIZE_Src) + (26)];
		tmp_g_aiT3217 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[26][i0];
		tmp_Src18 = tokens_Src[(index_Src % SIZE_Src) + (30)];
		tmp_g_aiT3218 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[30][i0];
	...
	while (i1 <= 15) {
		...
		tmp_g_aiT3219 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[1][i1];
		tmp_Src20 = tokens_Src[(index_Src % SIZE_Src) + (3)];
		tmp_g_aiT3220 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[3][i1];
		tmp_Src21 = tokens_Src[(index_Src % SIZE_Src) + (5)];
		tmp_g_aiT3221 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[5][i1];
		tmp_Src22 = tokens_Src[(index_Src % SIZE_Src) + (7)];
		tmp_g_aiT3222 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[7][i1];
		tmp_Src23 = tokens_Src[(index_Src % SIZE_Src) + (9)];
		tmp_g_aiT3223 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[9][i1];
		tmp_Src24 = tokens_Src[(index_Src % SIZE_Src) + (11)];
		tmp_g_aiT3224 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[11][i1];
		tmp_Src25 = tokens_Src[(index_Src % SIZE_Src) + (13)];
		tmp_g_aiT3225 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[13][i1];
		tmp_Src26 = tokens_Src[(index_Src % SIZE_Src) + (15)];
		tmp_g_aiT3226 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[15][i1];
		tmp_Src27 = tokens_Src[(index_Src % SIZE_Src) + (17)];
		tmp_g_aiT3227 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[17][i1];
		tmp_Src28 = tokens_Src[(index_Src % SIZE_Src) + (19)];
		tmp_g_aiT3228 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[19][i1];
		tmp_Src29 = tokens_Src[(index_Src % SIZE_Src) + (21)];
		tmp_g_aiT3229 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[21][i1];
		tmp_Src30 = tokens_Src[(index_Src % SIZE_Src) + (23)];
		tmp_g_aiT3230 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[23][i1];
		tmp_Src31 = tokens_Src[(index_Src % SIZE_Src) + (25)];
		tmp_g_aiT3231 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[25][i1];
		tmp_Src32 = tokens_Src[(index_Src % SIZE_Src) + (27)];
		tmp_g_aiT3232 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[27][i1];
		tmp_Src33 = tokens_Src[(index_Src % SIZE_Src) + (29)];
		tmp_g_aiT3233 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[29][i1];
		tmp_Src34 = tokens_Src[(index_Src % SIZE_Src) + (31)];
		tmp_g_aiT3234 = HevcDecoder_xIT_IT32x32_IT32x32_1d_0_g_aiT32[31][i1];
...
void HevcDecoder_xIT_IT32x32_IT32x32_1d_0_initialize(schedinfo_t *si) {
	int i = 0;
	write_Dst();
finished:
	write_end_Dst();
...
////////////////////////////////////////////////////////////////////////////////
// Action scheduler
void HevcDecoder_xIT_IT32x32_IT32x32_1d_0_scheduler(schedinfo_t *si) {
	int i = 0;
	si->ports = 0;
	...
	while (1) {
		if (numTokens_Src - index_Src >= 32 && isSchedulable_untagged_0()) {
			int stop = 0;
			if (32 > SIZE_Dst - index_Dst + HevcDecoder_xIT_IT32x32_IT32x32_1d_0_Dst->read_inds[0]) {
				stop = 1;
			}
			if (stop != 0) {
				si->num_firings = i;
