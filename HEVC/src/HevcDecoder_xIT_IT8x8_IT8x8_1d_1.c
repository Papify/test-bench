...
////////////////////////////////////////////////////////////////////////////////
// Input FIFOs
extern fifo_i16_t *HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Src;
...
#define tokens_Src HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Src->contents

extern connection_t connection_HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Src;
#define rate_Src connection_HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Src.rate
...
////////////////////////////////////////////////////////////////////////////////
// Output FIFOs
extern fifo_i16_t *HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Dst;
...
#define tokens_Dst HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Dst->contents
...
static const i8 HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[8][8] = {{64, 64, 64, 64, 64, 64, 64, 64}, {89, 75, 50, 18, -18, -50, -75, -89}, {83, 36, -36, -83, -83, -36, 36, 83}, {75, -18, -89, -50, 50, 89, 18, -75}, {64, -64, -64, 64, 64, -64, -64, 64}, {50, -89, 18, 75, -75, -18, 89, -50}, {36, -83, 83, -36, -36, 83, -83, 36}, {18, -50, 75, -89, 89, -75, 50, -18}};
...
static void read_Src() {
	index_Src = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Src->read_inds[0];
	numTokens_Src = index_Src + fifo_i16_get_num_tokens(HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Src, 0);
}

static void read_end_Src() {
	HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Src->read_inds[0] = index_Src;
}

static void write_Dst() {
	index_Dst = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Dst->write_ind;
	numFree_Dst = index_Dst + fifo_i16_get_room(HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Dst, NUM_READERS_Dst, SIZE_Dst);
}

static void write_end_Dst() {
	HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Dst->write_ind = index_Dst;
}
...
static void untagged_0_aligned() {
	...
	tmp_g_aiT8 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[0][0];
	tmp_Src0 = tokens_Src[(index_Src % SIZE_Src) + (4)];
	tmp_g_aiT80 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[4][0];
	evenEven[0] = tmp_Src * tmp_g_aiT8 + tmp_Src0 * tmp_g_aiT80;
	tmp_Src1 = tokens_Src[(index_Src % SIZE_Src) + (0)];
	tmp_g_aiT81 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[0][1];
	tmp_Src2 = tokens_Src[(index_Src % SIZE_Src) + (4)];
	tmp_g_aiT82 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[4][1];
	evenEven[1] = tmp_Src1 * tmp_g_aiT81 + tmp_Src2 * tmp_g_aiT82;
	tmp_Src3 = tokens_Src[(index_Src % SIZE_Src) + (2)];
	tmp_g_aiT83 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[2][0];
	tmp_Src4 = tokens_Src[(index_Src % SIZE_Src) + (6)];
	tmp_g_aiT84 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[6][0];
	evenOdd[0] = tmp_Src3 * tmp_g_aiT83 + tmp_Src4 * tmp_g_aiT84;
	tmp_Src5 = tokens_Src[(index_Src % SIZE_Src) + (2)];
	tmp_g_aiT85 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[2][1];
	tmp_Src6 = tokens_Src[(index_Src % SIZE_Src) + (6)];
	tmp_g_aiT86 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[6][1];
	...
	tmp_g_aiT87 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[1][0];
	tmp_Src8 = tokens_Src[(index_Src % SIZE_Src) + (3)];
	tmp_g_aiT88 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[3][0];
	tmp_Src9 = tokens_Src[(index_Src % SIZE_Src) + (5)];
	tmp_g_aiT89 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[5][0];
	tmp_Src10 = tokens_Src[(index_Src % SIZE_Src) + (7)];
	tmp_g_aiT810 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[7][0];
	...
	tmp_g_aiT811 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[1][1];
	tmp_Src12 = tokens_Src[(index_Src % SIZE_Src) + (3)];
	tmp_g_aiT812 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[3][1];
	tmp_Src13 = tokens_Src[(index_Src % SIZE_Src) + (5)];
	tmp_g_aiT813 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[5][1];
	tmp_Src14 = tokens_Src[(index_Src % SIZE_Src) + (7)];
	tmp_g_aiT814 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[7][1];
	...
	tmp_g_aiT815 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[1][2];
	tmp_Src16 = tokens_Src[(index_Src % SIZE_Src) + (3)];
	tmp_g_aiT816 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[3][2];
	tmp_Src17 = tokens_Src[(index_Src % SIZE_Src) + (5)];
	tmp_g_aiT817 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[5][2];
	tmp_Src18 = tokens_Src[(index_Src % SIZE_Src) + (7)];
	tmp_g_aiT818 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[7][2];
	...
	tmp_g_aiT819 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[1][3];
	tmp_Src20 = tokens_Src[(index_Src % SIZE_Src) + (3)];
	tmp_g_aiT820 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[3][3];
	tmp_Src21 = tokens_Src[(index_Src % SIZE_Src) + (5)];
	tmp_g_aiT821 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[5][3];
	tmp_Src22 = tokens_Src[(index_Src % SIZE_Src) + (7)];
	tmp_g_aiT822 = HevcDecoder_xIT_IT8x8_IT8x8_1d_1_g_aiT8[7][3];
...
void HevcDecoder_xIT_IT8x8_IT8x8_1d_1_initialize(schedinfo_t *si) {
	int i = 0;
	write_Dst();
finished:
	write_end_Dst();
...
////////////////////////////////////////////////////////////////////////////////
// Action scheduler
void HevcDecoder_xIT_IT8x8_IT8x8_1d_1_scheduler(schedinfo_t *si) {
	int i = 0;
	si->ports = 0;
	...
	while (1) {
		if (numTokens_Src - index_Src >= 8 && isSchedulable_untagged_0()) {
			int stop = 0;
			if (8 > SIZE_Dst - index_Dst + HevcDecoder_xIT_IT8x8_IT8x8_1d_1_Dst->read_inds[0]) {
				stop = 1;
			}
			if (stop != 0) {
				si->num_firings = i;
