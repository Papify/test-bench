...
static void write_O() {
	...
	numFree_O = index_O + fifo_u8_get_room(Source_O, NUM_READERS_O, SIZE_O);
}
...
extern void source_readNBytes(u8 outTable[524288], u32 nbTokenToRead);
